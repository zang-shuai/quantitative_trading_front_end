<template>
  ...
  <splitpanes vertical style="height: 800px">
    <pane>
      <span style="width: 100%;/*height: 100%*/">
        <div style="border: #111111 2px solid">
        <code-editor/>
        </div>
      </span>
    </pane>
...
export default {
  ...
  setup() {
    function drawImg2() {
      ...
      // let daily = []
      //
      // axios.get('http://127.0.0.1:8080/api/get_k_image', {
      //   params: {
      ...
      function splitData(rawData) {
        ...
        for (let i = 0; i < rawData.length; i++) {
          // console.log(rawData[i].splice(0, 1))
